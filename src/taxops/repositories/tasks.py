...
_ACTIVE_OWNER_SQL = (
    ...
    " AND (workflow_tasks.client_id IS NULL"
    " OR e.client_id = workflow_tasks.client_id)"
    "))"
    ...
    " AND workflow_tasks.client_id = aw.client_id"
    " AND ((awi.engagement_id IS NULL"
    " AND workflow_tasks.engagement_id IS NULL)"
    " OR (awi.engagement_id = workflow_tasks.engagement_id"
    " AND EXISTS (SELECT 1 FROM engagements ae"
    " WHERE ae.id = awi.engagement_id AND ae.client_id = aw.client_id"
